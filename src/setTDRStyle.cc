//Program taken from lbrianza repository: https://github.com/ECALELFS/ECALELF/blob/newMaster/ZFitter/src/setTDRStyle.cc
...
void setTDRStyle()
{
  ...
  tdrStyle->SetTitleOffset(1.30, "Z");
  tdrStyle->SetTitleOffset(0.8, "Y"); // Another way to set the Offset
  tdrStyle->SetTitleOffset(0.8,"X");
