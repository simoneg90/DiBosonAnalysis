...
void fit_Signal_new()
{
  ...
  std::string match= "ak08Puppi_1_tau21>.4&&genW_genBquark2_DR>.8&&genW_genBquark1_DR>.8&&ak08Ungroomed_WGen_DR<.1";
  std::string unmatch= "ak08Puppi_1_tau21>.55&&((genW_genBquark1_DR<.8&&ak08Ungroomed_WGen_DR<.1)||(genW_genBquark2_DR<.8&&ak08Ungroomed_WGen_DR<.1)||(genW_genBquark2_DR<.8&&genW_genBquark1_DR<.8&&ak08Ungroomed_WGen_DR<.1)||ak08Ungroomed_WGen_DR>.1)";
  std::string pass= "ak08Puppi_1_tau21>.55";




  std::string cut_matched_pass = "((abs(lepton_pdgID)==11&&((abs(lepton_eta)>0&&abs(lepton_eta)<1.442)||(abs(lepton_eta)>1.56&&abs(lepton_eta)<2.5))&&metType1>80&&lepton_pt>120&&ak08Ungroomed_lepton_DR>1)||(abs(lepton_pdgID)==13&&muonRelIso03<0.1&&metType1>40&&lepton_pt>40))&&(btag_medium>0)&&ak08Ungroomed_1_pt>200&&WType1_pt>200&&lepton_goodNumber==1&&ak08Puppi_1_tau21<6&&genW_genBquark2_DR>.8&&genW_genBquark1_DR>.8&&ak08Ungroomed_WGen_DR<.1";//((genW_genBquark2_DR<1.&&genW_genBquark1_DR<1.&&ak08Ungroomed_WGen_DR<.1)||ak08Ungroomed_WGen_DR>1.)";
  //std::string cut_matched_pass = "((abs(lepton_pdgID)==11&&((abs(lepton_eta)>0&&abs(lepton_eta)<1.442)||(abs(lepton_eta)>1.56&&abs(lepton_eta)<2.5))&&metType1>80&&lepton_pt>120&&ak08Ungroomed_lepton_DR>1)||(abs(lepton_pdgID)==13&&muonRelIso03<0.1&&metType1>40&&lepton_pt>40))&&btag_medium>0&&ak08Ungroomed_1_pt>200&&WType1_pt>200&&lepton_goodNumber==1&&ak08Ungroomed_WGen_DR<.1&&genW_genBquark1_DR>1.&&genW_genBquark2_DR>1.";//&&lepton_WGen_DR>1.";//genW_genBquark1_DR>1.&&genW_genBquark2_DR>1.&&ak08Puppi_1_tau21<2";//&&lepton_WGen_DR>1.";//&&genW_genBquark1_DR>1.&&genW_genBquark2_DR>1.";//&&genW_genBquarkMin_DR>3.&&genW_genBquarkMax_DR>2";//subjet1_qGen1_DR<0.1&&subjet2_qGen2_DR<0.1&&ak08_subjetDR<0.1&&subjet1_btagLoose==0&&subjet2_btagLoose==0";
  std::string cut_unmatched_pass = "((abs(lepton_pdgID)==11&&((abs(lepton_eta)>0&&abs(lepton_eta)<1.442)||(abs(lepton_eta)>1.56&&abs(lepton_eta)<2.5))&&metType1>80&&lepton_pt>120&&ak08Ungroomed_lepton_DR>1)||(abs(lepton_pdgID)==13&&muonRelIso03<0.1&&metType1>40&&lepton_pt>40))&&(btag_medium>0)&&ak08Ungroomed_1_pt>200&&WType1_pt>200&&lepton_goodNumber==1&&ak08Puppi_1_tau21>.6&&((genW_genBquark1_DR<.8&&ak08Ungroomed_WGen_DR<.1)||(genW_genBquark2_DR<.8&&ak08Ungroomed_WGen_DR<.1)||(genW_genBquark2_DR<.8&&genW_genBquark1_DR<.8&&ak08Ungroomed_WGen_DR<.1)||ak08Ungroomed_WGen_DR>.1)";//&&subjet1_btagTight==0&&subjet2_btagTight==0&&ak08_subjetDR<.3";
//"((abs(lepton_pdgID)==11&&((abs(lepton_eta)>0&&abs(lepton_eta)<1.442)||(abs(lepton_eta)>1.56&&abs(lepton_eta)<2.5))&&metType1>80&&lepton_pt>120&&ak08Ungroomed_lepton_DR>1)||(abs(lepton_pdgID)==13&&muonRelIso03<0.1&&metType1>40&&lepton_pt>40))&&(btag_tight>0)&&ak08Ungroomed_1_pt>200&&WType1_pt>200&&ak08Puppi_1_tau21<0.6&&ak08Ungroomed_WGen_DR>.1&&subjet1_qGen1_DR<0.1&&subjet2_qGen2_DR<0.1&&ak08_subjetDR<0.1&&lepton_goodNumber==1";//&&lepton_WGen_DR>1";
  std::string cut_pass = "((abs(lepton_pdgID)==11&&((abs(lepton_eta)>0&&abs(lepton_eta)<1.442)||(abs(lepton_eta)>1.56&&abs(lepton_eta)<2.5))&&metType1>80&&lepton_pt>120&&ak08Ungroomed_lepton_DR>1)||(abs(lepton_pdgID)==13&&muonRelIso03<0.1&&metType1>40&&lepton_pt>40))&&(btag_loose>0&&btag_medium>0)&&ak08Ungroomed_1_pt>200&&WType1_pt>200&&ak08Puppi_1_tau21>.6&lepton_goodNumber==1";//&&subjet1_btagLoose==0&&subjet2_btagLoose==0&&ak08_subjetDR<0.1";//"((abs(lepton_pdgID)==11&&((abs(lepton_eta)>0&&abs(lepton_eta)<1.442)||(abs(lepton_eta)>1.56&&abs(lepton_eta)<2.5))&&metType1>80&&lepton_pt>120&&ak08Ungroomed_lepton_DR>1&&lepton_goodNumber==1)||(abs(lepton_pdgID)==13&&muonRelIso03<0.1&&metType1>40&&lepton_pt>40))&&btag_medium>0&&ak08Ungroomed_1_pt>200&&WType1_pt>200&&ak08Puppi_1_tau21<0.6";
  std::string cut_fail = "((abs(lepton_pdgID)==11&&((abs(lepton_eta)>0&&abs(lepton_eta)<1.442)||(abs(lepton_eta)>1.56&&abs(lepton_eta)<2.5))&&metType1>80&&lepton_pt>120&&ak08Ungroomed_lepton_DR>1&&lepton_goodNumber==1)||(abs(lepton_pdgID)==13&&muonRelIso03<0.1&&metType1>40&&lepton_pt>40))&&btag_medium>0&&ak08Ungroomed_1_pt>200&&WType1_pt>200&&ak08Puppi_1_tau21>0.6";
  std::string cut = "abs(lepton_pdgID)==13&&muonRelIso03<0.1&&metType1>40&&btag_medium>0&&lepton_pt>40&&ak08Ungroomed_1_pt>200&&WType1_pt>200&&ak08CustomPuppi_MCorr>40&&ak08CustomPuppi_MCorr<150&&ak08Puppi_1_tau21<0.6&&ak08Ungroomed_WGen_DR<0.1";
  std::string variable="ak08CustomPuppi_MCorr";
  ...
  RooRealVar ak08CustomPuppi_MCorr("ak08CustomPuppi_MCorr","ak08CustomPuppi_MCorr", 40,130);
  RooRealVar ak08Puppi_1_tau21("ak08Puppi_1_tau21","ak08Puppi_1_tau21", 0,1);
  ...
  TFile *file_ttbar2;
  file_ttbar2=TFile::Open("../dibosonOutputNov2016/TT_pow_ext3/rootfile_TT_pow_ext3__0_reduced_skim_redu.root");//"../output/TTBar_out_reduced_skim_redu.root");//"/afs/cern.ch/work/s/sgelli/private/CMSSW_Analysis/src/DiBosonAnalysis/ttbar_output_new/TT_Inclusive_redu.root");//ttbar_redu.root");
  ...
  RooDataSet *ds_ttbar = new RooDataSet("ds_ttbar","ds_ttbar",RooArgSet(ak08CustomPuppi_MCorr, ak08Puppi_1_tau21,ak08Ungroomed_1_pt,genW_genBquark1_DR,genW_genBquark2_DR,ak08Ungroomed_WGen_DR),Import(*tree_ttbar));//,Cut(Form("%s", cut_matched_pass.c_str())));//, (xSec_ttbar*Lumi/nEvt_ttbar)) ;
  ...
  //w_ttbar.setVal(2);
  RooFormulaVar wFunc_ttbar("wFunc_ttbar","event weight","w_ttbar",RooArgList(w_ttbar,ak08CustomPuppi_MCorr)) ;
  RooFormulaVar *wFunc_ttbar1[10];
  std::cout<<"++*"<<std::endl;
  wFunc_ttbar1[0]= new RooFormulaVar("wFunc_ttbar1","event weight","w_ttbar",RooArgList(w_ttbar,ak08CustomPuppi_MCorr)) ;
  std::cout<<"++*"<<std::endl;
  //wFunc_ttbar1[0]= new RooFormulaVar("wFunc_ttbar1_0","event weight","w_ttbar",RooArgList(w_ttbar,ak08CustomPuppi_MCorr)) ;
  //wFunc_mio[0]=new RooFormulaVar("wFunc_mio0","wFunc_mio0","mioPeso0",RooArgList((const RooAbsArg)mioPeso[0],ak08CustomPuppi_MCorr)) ;
  ...
  RooGaussian gx_ttbar("gx_ttbar","gx",ak08CustomPuppi_MCorr,mean_ttbar,sigma_ttbar) ;
  ...
  RooGaussian gx_ttbar1("gx_ttbar1","gx",ak08CustomPuppi_MCorr,mean_ttbar1,sigma_ttbar1) ;
  ...
  /*RooCBShape test_("test_","", ak08CustomPuppi_MCorr_ttbar, mean_ttbar, sigma_ttbar, a1_ttbar, a_ttbar); 
  */RooChebychev cheby_ttbar("cheby_ttbar","cheby_ttbar",ak08CustomPuppi_MCorr,RooArgSet(a_ttbar,a1_ttbar, a2_ttbar)) ;
  /*RooPolynomial p2_ttbar("p2_ttbar","p2",ak08CustomPuppi_MCorr,RooArgList(a_ttbar,a1_ttbar, a2_ttbar),0) ;
  ...
  */RooRealVar dCBPowR_ttbar("dCBPowR_ttbar","a_ttbar",.3, 0.2, 15.);
  ...
  RooDCBShape dcb("dcb", "double crystal ball", ak08CustomPuppi_MCorr, mean_ttbar, sigma_ttbar, dCBCutL_ttbar, dCBPowL_ttbar, dCBCutR_ttbar,dCBPowR_ttbar); //const_mean_pass_sim_MC, const_sigma_pass_sim_MC,// const_dCBCutL_pass_sim_MC, const_dCBCutR_pass_sim_MC, const_dCBPowerL_pass_sim_MC, const_dCBPowerR_pass_sim_MC);
  ...
  RooDCBShape dcb_unmatch("dcb_unmatch", "double crystal ball", ak08CustomPuppi_MCorr, mean_ttbar_unmatch, sigma_ttbar_unmatch, dCBCutL_ttbar_unmatch, dCBPowL_ttbar_unmatch, dCBCutR_ttbar_unmatch,dCBPowR_ttbar_unmatch);
  //model_ttbar.fitTo(*dh_ttbarMatch) ;
  //test_.fitTo(*dh_ttbarMatch) ;
  RooRealVar n2_ttbar("n2_ttbar","n2_ttbar", 20,-100,100);
  //My_double_CB chib= My_double_CB("chib", "chib", ak08CustomPuppi_MCorr, mean_ttbar, sigma_ttbar, a1_ttbar, a_ttbar, a2_ttbar, n2_ttbar);
...
//  dcb.fitTo(*wdata_ttbar_match, RooFit::SumW2Error(kTRUE), RooFit::Strategy(2)) ;
  ...
  RooPlot* frame1_ttbar = ak08CustomPuppi_MCorr.frame(Bins(nbins),Title("TopTop Pass/Match sample")) ;
  ...
  RooPlot* frame2_ttbar = ak08CustomPuppi_MCorr.frame(Bins(nbins),Title("TopTop Pass/UnMatch sample")) ;
  ...
  std::cout<<"+++++++++++++++++++"<<std::endl;
  TFile *file_Stop1;
  file_Stop1=TFile::Open("../dibosonOutputNov2016/TToLeptons_sch/rootfile_TToLeptons_sch__0_reduced_skim.root");//"/cmshome/gellisim/Diboson/CMSSW_7_4_15/src/DiBosonAnalysis/rootFolder9/ST_s-channel_4f.root");//testMuonEff/firstTest_reduced_skim.root");
  ...
  file_Stop1_primo=TFile::Open("../dibosonOutputNov2016/TToLeptons_sch/rootfile_TToLeptons_sch__0_reduced_skim_redu.root");//"../ttbar_output_new/SingleTop_sChannel_20160703_141827/rootfile_SingleTop_sChannel__20160703_141827_0_reduced_skim_redu.root");//"/cmshome/gellisim/Diboson/CMSSW_7_4_15/src/DiBosonAnalysis/rootFolder9/ST_s-channel_4f_redu.root");
  TTree *tree_Stop1=(TTree *)file_Stop1_primo->Get("mio");
  
  RooDataSet ds_Stop1("ds_Stop1","ds_ttbar",RooArgSet(ak08CustomPuppi_MCorr, ak08Puppi_1_tau21,ak08Ungroomed_1_pt,genW_genBquark1_DR,genW_genBquark2_DR,ak08Ungroomed_WGen_DR),Import(*tree_Stop1));//,Cut(Form("%s", cut_matched_pass.c_str())));//, (xSec_ttbar*Lumi/nEvt_ttbar)) ;
  ds_ttbar->Print();
  ...
  RooFormulaVar wFunc_Stop1("wFunc_Stop1","event weight","w_Stop1",RooArgList(w_Stop1,ak08CustomPuppi_MCorr)) ;
  ...
  TFile *file_Stop2;
  file_Stop2=TFile::Open("../dibosonOutputNov2016/T_tWch/rootfile_T_tWch__0_reduced_skim.root");//"/cmshome/gellisim/Diboson/CMSSW_7_4_15/src/DiBosonAnalysis/rootFolder9/ST_tW-channel_top.root");//testMuonEff/firstTest_reduced_skim.root");
  ...
  file_Stop2_primo=TFile::Open("../dibosonOutputNov2016/T_tWch/rootfile_T_tWch__0_reduced_skim_redu.root");//"../ttbar_output_new/SingleTop_tW_20160703_141828/rootfile_SingleTop_tW__20160703_141828_0_reduced_skim_redu.root");
  TTree *tree_Stop2=(TTree *)file_Stop2_primo->Get("mio");
  
  RooDataSet ds_Stop2("ds_Stop2","ds_ttbar",RooArgSet(ak08CustomPuppi_MCorr, ak08Puppi_1_tau21,ak08Ungroomed_1_pt,genW_genBquark1_DR,genW_genBquark2_DR,ak08Ungroomed_WGen_DR),Import(*tree_Stop2));//,Cut(Form("%s", cut_matched_pass.c_str())));//, (xSec_ttbar*Lumi/nEvt_ttbar)) ;
  ...
  RooFormulaVar wFunc_Stop2("wFunc_Stop2","event weight","w_Stop2",RooArgList(w_Stop2,ak08CustomPuppi_MCorr)) ;
  ...
  TFile *file_Stop3; 
  file_Stop3=TFile::Open("../dibosonOutputNov2016/TBar_tWch/rootfile_TBar_tWch__0_reduced_skim.root");//testMuonEff/firstTest_reduced_skim.root");
  ...
  file_Stop3_primo=TFile::Open("../dibosonOutputNov2016/TBar_tWch/rootfile_TBar_tWch__0_reduced_skim_redu.root");//"../ttbar_output_new/SingleTop_tbarW_20160703_141828/rootfile_SingleTop_tbarW__20160703_141828_0_reduced_skim_redu.root");
  TTree *tree_Stop3=(TTree *)file_Stop3_primo->Get("mio");
  
  RooDataSet ds_Stop3("ds_Stop3","ds_ttbar",RooArgSet(ak08CustomPuppi_MCorr, ak08Puppi_1_tau21,ak08Ungroomed_1_pt,genW_genBquark1_DR,genW_genBquark2_DR,ak08Ungroomed_WGen_DR),Import(*tree_Stop3));//,Cut(Form("%s", cut_matched_pass.c_str())));//, (xSec_ttbar*Lumi/nEvt_ttbar)) ;
  ...
  RooFormulaVar wFunc_Stop3("wFunc_Stop3","event weight","w_Stop3",RooArgList(w_Stop3,ak08CustomPuppi_MCorr)) ;
...
///////  
///////  RooDataSet ds_Stop4("ds_Stop4","ds_ttbar",RooArgSet(ak08CustomPuppi_MCorr, ak08Puppi_1_tau21,ak08Ungroomed_1_pt,genW_genBquark1_DR,genW_genBquark2_DR,ak08Ungroomed_WGen_DR),Import(*tree_Stop4));//,Cut(Form("%s", cut_matched_pass.c_str())));//, (xSec_ttbar*Lumi/nEvt_ttbar)) ;
///////      
...
///////  RooFormulaVar wFunc_Stop4("wFunc_Stop4","event weight","w_Stop4",RooArgList(w_Stop4,ak08CustomPuppi_MCorr)) ;
...
///////  
///////  RooDataSet ds_Stop5("ds_Stop5","ds_ttbar",RooArgSet(ak08CustomPuppi_MCorr, ak08Puppi_1_tau21,ak08Ungroomed_1_pt,genW_genBquark1_DR,genW_genBquark2_DR,ak08Ungroomed_WGen_DR),Import(*tree_Stop5));//,Cut(Form("%s", cut_matched_pass.c_str())));//, (xSec_ttbar*Lumi/nEvt_ttbar)) ;
///////      
...
///////  RooFormulaVar wFunc_Stop5("wFunc_Stop5","event weight","w_Stop5",RooArgList(w_Stop5,ak08CustomPuppi_MCorr)) ;
...
////  nuovo->append(*wdata_ttbar_match); 
  ...
  dcb.fitTo(*wdata_ttbar_match, RooFit::SumW2Error(kTRUE), RooFit::Strategy(2)) ;
  dcb.fitTo(*wdata_ttbar_match, RooFit::SumW2Error(kTRUE), RooFit::Strategy(2)) ;
  RooPlot* testMio= ak08CustomPuppi_MCorr.frame(Bins(nbins),Title("total Match sample")) ;
  ...
  RooGaussian gx_Stop("gx_Stop","gx",ak08CustomPuppi_MCorr,mean_Stop,sigma_Stop) ;
  ...
  RooGaussian gx_Stop1("gx_Stop1","gx",ak08CustomPuppi_MCorr,mean_Stop1,sigma_Stop1) ;
  ...
  //RooPolynomial p2_ttbar("p2_ttbar","p2",ak08CustomPuppi_MCorr,RooArgList(a_ttbar,a1_ttbar, a2_ttbar),0) ;
  RooChebychev cheby_Stop("cheby_Stop","cheby_Stop",ak08CustomPuppi_MCorr,RooArgSet(a_Stop,a1_Stop, a2_Stop)) ;
...
///  wdata_Stop1_match.append(wdata_Stop4_match);
  ...
  //Plotting
  RooPlot* frame1_Stop = ak08CustomPuppi_MCorr.frame(Bins(nbins),Title("Single Top Pass/Match sample")) ;
...
//////  //gx1.plotOn(frame1,Slice(sample,"physics"),ProjWData(sample,combData), LineColor(kRed)) ;
  RooPlot* frame2_Stop = ak08CustomPuppi_MCorr.frame(Bins(nbins),Title("Single Top Pass/UnMatch sample")) ;
...
//  c_Stop->cd(2) ; gPad->SetLeftMargin(0.15) ; frame2_Stop->GetYaxis()->SetTitleOffset(1.4) ; frame2_Stop->Draw() ;
  ...
  RooDataSet ds_WW("ds_WW","ds_ttbar",RooArgSet(ak08CustomPuppi_MCorr, ak08Puppi_1_tau21,ak08Ungroomed_1_pt,genW_genBquark1_DR,genW_genBquark2_DR,ak08Ungroomed_WGen_DR),Import(*tree_WW));//,Cut(Form("%s", cut_matched_pass.c_str())));//, (xSec_ttbar*Lumi/nEvt_ttbar)) ;
  ...
  RooFormulaVar wFunc_WW("wFunc_WW","event weight","w_WW",RooArgList(w_WW,ak08CustomPuppi_MCorr)) ;
  ...
  RooDataSet ds_WZ("ds_WZ","ds_ttbar",RooArgSet(ak08CustomPuppi_MCorr, ak08Puppi_1_tau21,ak08Ungroomed_1_pt,genW_genBquark1_DR,genW_genBquark2_DR,ak08Ungroomed_WGen_DR),Import(*tree_WZ));//,Cut(Form("%s", cut_matched_pass.c_str())));//, (xSec_ttbar*Lumi/nEvt_ttbar)) ;
  ...
  RooFormulaVar wFunc_WZ("wFunc_WZ","event weight","w_WZ",RooArgList(w_WZ,ak08CustomPuppi_MCorr)) ;
  ...
  RooDataSet ds_ZZ("ds_ZZ","ds_ttbar",RooArgSet(ak08CustomPuppi_MCorr, ak08Puppi_1_tau21,ak08Ungroomed_1_pt,genW_genBquark1_DR,genW_genBquark2_DR,ak08Ungroomed_WGen_DR),Import(*tree_ZZ));//,Cut(Form("%s", cut_matched_pass.c_str())));//, (xSec_ttbar*Lumi/nEvt_ttbar)) ;
  ...
  RooFormulaVar wFunc_ZZ("wFunc_ZZ","event weight","w_ZZ",RooArgList(w_ZZ,ak08CustomPuppi_MCorr)) ;
  ...
  RooDataSet ds_W_100_200("ds_W_100_200","ds_ttbar",RooArgSet(ak08CustomPuppi_MCorr, ak08Puppi_1_tau21,ak08Ungroomed_1_pt,genW_genBquark1_DR,genW_genBquark2_DR,ak08Ungroomed_WGen_DR),Import(*tree_W_100_200));//,Cut(Form("%s", cut_matched_pass.c_str())));//, (xSec_ttbar*Lumi/nEvt_ttbar)) ;
  ...
  RooFormulaVar wFunc_W_100_200("wFunc_W_100_200","event weight","w_W_100_200",RooArgList(w_W_100_200,ak08CustomPuppi_MCorr)) ;
  ...
  RooDataSet ds_W_200_400("ds_W_200_400","ds_ttbar",RooArgSet(ak08CustomPuppi_MCorr, ak08Puppi_1_tau21,ak08Ungroomed_1_pt,genW_genBquark1_DR,genW_genBquark2_DR,ak08Ungroomed_WGen_DR),Import(*tree_W_200_400));//,Cut(Form("%s", cut_matched_pass.c_str())));//, (xSec_ttbar*Lumi/nEvt_ttbar)) ;
  ...
  RooFormulaVar wFunc_W_200_400("wFunc_W_200_400","event weight","w_W_200_400",RooArgList(w_W_200_400,ak08CustomPuppi_MCorr)) ;
  ...
  RooDataSet ds_W_400_600("ds_W_400_600","ds_ttbar",RooArgSet(ak08CustomPuppi_MCorr, ak08Puppi_1_tau21,ak08Ungroomed_1_pt,genW_genBquark1_DR,genW_genBquark2_DR,ak08Ungroomed_WGen_DR),Import(*tree_W_400_600));//,Cut(Form("%s", cut_matched_pass.c_str())));//, (xSec_ttbar*Lumi/nEvt_ttbar)) ;
  ...
  RooFormulaVar wFunc_W_400_600("wFunc_W_400_600","event weight","w_W_400_600",RooArgList(w_W_400_600,ak08CustomPuppi_MCorr)) ;
  ...
  RooDataSet ds_W_600_800("ds_W_600_800","ds_ttbar",RooArgSet(ak08CustomPuppi_MCorr, ak08Puppi_1_tau21,ak08Ungroomed_1_pt,genW_genBquark1_DR,genW_genBquark2_DR,ak08Ungroomed_WGen_DR),Import(*tree_W_600_800));//,Cut(Form("%s", cut_matched_pass.c_str())));//, (xSec_ttbar*Lumi/nEvt_ttbar)) ;
  ...
  RooFormulaVar wFunc_W_600_800("wFunc_W_600_800","event weight","w_W_600_800",RooArgList(w_W_600_800,ak08CustomPuppi_MCorr)) ;
  ...
  RooDataSet ds_W_800_1200("ds_W_800_1200","ds_ttbar",RooArgSet(ak08CustomPuppi_MCorr, ak08Puppi_1_tau21,ak08Ungroomed_1_pt,genW_genBquark1_DR,genW_genBquark2_DR,ak08Ungroomed_WGen_DR),Import(*tree_W_800_1200));//,Cut(Form("%s", cut_matched_pass.c_str())));//, (xSec_ttbar*Lumi/nEvt_ttbar)) ;
  ...
  RooFormulaVar wFunc_W_800_1200("wFunc_W_800_1200","event weight","w_W_800_1200",RooArgList(w_W_800_1200,ak08CustomPuppi_MCorr)) ;
  ...
  RooDataSet ds_W_1200_2500("ds_W_1200_2500","ds_ttbar",RooArgSet(ak08CustomPuppi_MCorr, ak08Puppi_1_tau21,ak08Ungroomed_1_pt,genW_genBquark1_DR,genW_genBquark2_DR,ak08Ungroomed_WGen_DR),Import(*tree_W_1200_2500));//,Cut(Form("%s", cut_matched_pass.c_str())));//, (xSec_ttbar*Lumi/nEvt_ttbar)) ;
  ...
  RooFormulaVar wFunc_W_1200_2500("wFunc_W_1200_2500","event weight","w_W_1200_2500",RooArgList(w_W_1200_2500,ak08CustomPuppi_MCorr)) ;
  ...
  RooDataSet ds_W_2500_Inf("ds_W_2500_Inf","ds_ttbar",RooArgSet(ak08CustomPuppi_MCorr, ak08Puppi_1_tau21,ak08Ungroomed_1_pt,genW_genBquark1_DR,genW_genBquark2_DR,ak08Ungroomed_WGen_DR),Import(*tree_W_2500_Inf));//,Cut(Form("%s", cut_matched_pass.c_str())));//, (xSec_ttbar*Lumi/nEvt_ttbar)) ;
  ...
  RooFormulaVar wFunc_W_2500_Inf("wFunc_W_2500_Inf","event weight","w_W_2500_Inf",RooArgList(w_W_2500_Inf,ak08CustomPuppi_MCorr)) ;
  ...
  */RooChebychev cheby_pass_bkg("cheby_pass_bkg","cheby_pass",ak08CustomPuppi_MCorr,RooArgList(a_pass_bkg,a1_pass_bkg, a2_pass_bkg)) ;
  RooPolynomial pol_bkg("pol_bkg","pol_bkg", ak08CustomPuppi_MCorr,RooArgList(a_pass_bkg,a1_pass_bkg, a2_pass_bkg),0);
  ...
  RooGaussian gx_bkg("gx_bkg","gx_bkg",ak08CustomPuppi_MCorr,mean_bkg,sigma_bkg) ;
  RooRealVar mean_bkg1("mean_bkg1","mean_bkg1", 80, 60,95);
  RooRealVar sigma_bkg1("sigma_bkg1","sigma_bkg1", 30, 0,100);
  RooGaussian gx_bkg1("gx_bkg1","gx_bkg1",ak08CustomPuppi_MCorr,mean_bkg1,sigma_bkg1) ;
  RooRealVar k_bkg("k_bkg","k_bkg", 2, 0,5);
  RooAddPdf model_bkg("model_bkg", "model_bkg", RooArgList(gx_bkg,gx_bkg1), RooArgList(k_bkg));
  RooChebychev p2("p2","p2",ak08CustomPuppi_MCorr,RooArgSet(a_bkg,a1_bkg,a2_bkg));//,0) ;
  //RooGenericPdf passBkg("passBkg", "passBkg", "(1+(TMath::Erf((ak08CustomPuppi_MCorr-a_bkg)/b_bkg)))*0.5*exp(-(mean_bkg-ak08CustomPuppi_MCorr)*(mean_bkg-ak08CustomPuppi_MCorr)/(2*sigma_bkg*sigma_bkg))", RooArgSet(ak08CustomPuppi_MCorr, a_bkg, b_bkg, mean_bkg, sigma_bkg));
  RooRealVar a_bkg_exp("a_bkg_exp","a_bkg_exp", .1,-1,1);
  RooExponential exp_bkg("exp_bkg","exp_bkg", ak08CustomPuppi_MCorr, a_bkg_exp);
  RooConstVar slope("slope","slope", -5.); 
  RooRealVar cutOff("cutOff","cutOff", 40,100,170);
  RooRealVar pow("pow","pow",10,-20,20);
  RooArgusBG argus("argus","argus", ak08CustomPuppi_MCorr,cutOff, slope, pow);//a_pass_bkg,a1_pass_bkg, a2_pass_bkg);
//////  cheby_pass_bkg/*exp_bkg*/.fitTo(*dh_bkgPass) ;
  
  
  RooDCBShape dcb_unmatch1("dcb_unmatch1", "double crystal ball", ak08CustomPuppi_MCorr, mean_ttbar_unmatch, sigma_ttbar_unmatch, dCBCutL_ttbar_unmatch, dCBPowL_ttbar_unmatch, dCBCutR_ttbar_unmatch,dCBPowR_ttbar_unmatch);
  ...
  RooPlot* frame1_bkg = ak08CustomPuppi_MCorr.frame(Bins(nbins),Title("BackGround Pass sample")) ;
  ...
  RooErfExpPdf model_pdf /*      = new RooErfExpPdf*/("model_pdf","model_pdf",ak08CustomPuppi_MCorr,rrv_c_ErfExp,rrv_offset_ErfExp,rrv_width_ErfExp);
  ...
  RooGaussian gx_pass("gx_pass","gx_pass",ak08CustomPuppi_MCorr,mean_pass,sigma_pass) ;
  
  RooRealVar mean_pass1("mean_pass1","mean_pass1", 120, 70,130);
  RooRealVar sigma_pass1("sigma_pass1","sigma_pass1", 10, 0,40);
  RooGaussian gx_pass1("gx_pass1","gx_pass1",ak08CustomPuppi_MCorr,mean_pass1,sigma_pass1) ;
  ...
  RooPolynomial p2_pass("p2_pass","p2_pass",ak08CustomPuppi_MCorr,RooArgList(a_pass,a1_pass,a2_pass),0) ;
  ...
  RooDCBShape dcbx("dcbx", "double crystal ball", ak08CustomPuppi_MCorr, mean_ttbarx, sigma_ttbarx, a1_ttbarx, a_ttbarx, a1_ttbar1x, a_ttbar1x);
  ...
  RooRealVar a1_pass1("a1_pass1","a1_Stop", 0.1,-1,1);
  RooRealVar a2_pass1("a2_pass1","a2_Stop", -0.1,-1,1);
  */RooChebychev cheby_pass("cheby_pass","cheby_pass",ak08CustomPuppi_MCorr,RooArgSet(a_pass1,a1_pass1, a2_pass1));//, a2_pass1, a_pass)) ;
...
//  modelPass.fitTo(*wdata_ttbar_match, RooFit::SumW2Error(kTRUE), RooFit::Strategy(2)) ;
  ...
  RooPlot* frame1_pass = ak08CustomPuppi_MCorr.frame(Bins(nbins),Title("Pass sample")) ;
