...
// Tue Dec  1 16:04:07 2015 by ROOT version 6.02/05
// from TChain tree/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         FatjetCA15ungroomed_pt[6];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_eta[6];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_phi[6];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_mass[6];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_tau1[6];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_tau2[6];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_tau3[6];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_bbtag[6];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_PFLepton_ptrel[6];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_z_ratio[6];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_tau_dot[6];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_SV_mass_0[6];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_SV_EnergyRatio_0[6];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_SV_EnergyRatio_1[6];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_PFLepton_IP2D[6];   //[nFatjetCA15ungroomed]
   Float_t         FatjetCA15ungroomed_tau_21[6];   //[nFatjetCA15ungroomed]
   ...
   Int_t           naLeptons;
   Int_t           aLeptons_charge[5];   //[naLeptons]
   Int_t           aLeptons_tightId[5];   //[naLeptons]
   Int_t           aLeptons_eleCutIdCSA14_25ns_v1[5];   //[naLeptons]
   Int_t           aLeptons_eleCutIdCSA14_50ns_v1[5];   //[naLeptons]
   Int_t           aLeptons_eleCutIdSpring15_25ns_v1[5];   //[naLeptons]
   Float_t         aLeptons_dxy[5];   //[naLeptons]
   Float_t         aLeptons_dz[5];   //[naLeptons]
   Float_t         aLeptons_edxy[5];   //[naLeptons]
   Float_t         aLeptons_edz[5];   //[naLeptons]
   Float_t         aLeptons_ip3d[5];   //[naLeptons]
   Float_t         aLeptons_sip3d[5];   //[naLeptons]
   Int_t           aLeptons_convVeto[5];   //[naLeptons]
   Int_t           aLeptons_lostHits[5];   //[naLeptons]
   Float_t         aLeptons_relIso03[5];   //[naLeptons]
   Float_t         aLeptons_relIso04[5];   //[naLeptons]
   Float_t         aLeptons_miniRelIso[5];   //[naLeptons]
   Int_t           aLeptons_tightCharge[5];   //[naLeptons]
   Int_t           aLeptons_mcMatchId[5];   //[naLeptons]
   Int_t           aLeptons_mcMatchAny[5];   //[naLeptons]
   Int_t           aLeptons_mcMatchTau[5];   //[naLeptons]
   Float_t         aLeptons_mcPt[5];   //[naLeptons]
   Int_t           aLeptons_mediumMuonId[5];   //[naLeptons]
   Int_t           aLeptons_pdgId[5];   //[naLeptons]
   Float_t         aLeptons_pt[5];   //[naLeptons]
   Float_t         aLeptons_eta[5];   //[naLeptons]
   Float_t         aLeptons_phi[5];   //[naLeptons]
   Float_t         aLeptons_mass[5];   //[naLeptons]
   Int_t           aLeptons_looseIdSusy[5];   //[naLeptons]
   Int_t           aLeptons_looseIdPOG[5];   //[naLeptons]
   Float_t         aLeptons_chargedHadRelIso03[5];   //[naLeptons]
   Float_t         aLeptons_chargedHadRelIso04[5];   //[naLeptons]
   Float_t         aLeptons_eleSieie[5];   //[naLeptons]
   Float_t         aLeptons_eleDEta[5];   //[naLeptons]
   Float_t         aLeptons_eleDPhi[5];   //[naLeptons]
   Float_t         aLeptons_eleHoE[5];   //[naLeptons]
   Float_t         aLeptons_eleMissingHits[5];   //[naLeptons]
   Float_t         aLeptons_eleChi2[5];   //[naLeptons]
   Float_t         aLeptons_nStations[5];   //[naLeptons]
   Float_t         aLeptons_trkKink[5];   //[naLeptons]
   Float_t         aLeptons_caloCompatibility[5];   //[naLeptons]
   Float_t         aLeptons_globalTrackChi2[5];   //[naLeptons]
   Float_t         aLeptons_nChamberHits[5];   //[naLeptons]
   Float_t         aLeptons_isPFMuon[5];   //[naLeptons]
   Float_t         aLeptons_isGlobalMuon[5];   //[naLeptons]
   Float_t         aLeptons_isTrackerMuon[5];   //[naLeptons]
   Float_t         aLeptons_pixelHits[5];   //[naLeptons]
   Int_t           aLeptons_trackerLayers[5];   //[naLeptons]
   Int_t           aLeptons_pixelLayers[5];   //[naLeptons]
   Float_t         aLeptons_mvaTTH[5];   //[naLeptons]
   Int_t           aLeptons_jetOverlapIdx[5];   //[naLeptons]
   Float_t         aLeptons_jetPtRatio[5];   //[naLeptons]
   Float_t         aLeptons_jetBTagCSV[5];   //[naLeptons]
   Float_t         aLeptons_jetDR[5];   //[naLeptons]
   Float_t         aLeptons_pfRelIso03[5];   //[naLeptons]
   Float_t         aLeptons_pfRelIso04[5];   //[naLeptons]
   Float_t         aLeptons_etaSc[5];   //[naLeptons]
   Float_t         aLeptons_eleExpMissingInnerHits[5];   //[naLeptons]
   Float_t         aLeptons_eleooEmooP[5];   //[naLeptons]
   Int_t           nGenNuFromTop;
   ...
   Float_t         softActivityVHJets_pt[1];   //[nsoftActivityVHJets]
   Float_t         softActivityVHJets_eta[1];   //[nsoftActivityVHJets]
   Float_t         softActivityVHJets_phi[1];   //[nsoftActivityVHJets]
   Float_t         softActivityVHJets_mass[1];   //[nsoftActivityVHJets]
   Int_t           nDiscardedJet;
   Int_t           DiscardedJet_id[13];   //[nDiscardedJet]
   Int_t           DiscardedJet_puId[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagCSV[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagCMVA[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_rawPt[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_mcPt[13];   //[nDiscardedJet]
   Int_t           DiscardedJet_mcFlavour[13];   //[nDiscardedJet]
   Int_t           DiscardedJet_mcMatchId[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_corr_JECUp[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_corr_JECDown[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_corr[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_corr_JERUp[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_corr_JERDown[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_corr_JER[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_pt[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_eta[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_phi[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_mass[13];   //[nDiscardedJet]
   Int_t           DiscardedJet_idxFirstTauMatch[13];   //[nDiscardedJet]
   Int_t           DiscardedJet_heppyFlavour[13];   //[nDiscardedJet]
   Int_t           DiscardedJet_hadronFlavour[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagBDT[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagProb[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagBProb[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagSoftEl[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagSoftMu[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagnew[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_btagCSVV0[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_chHEF[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_neHEF[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_chEmEF[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_neEmEF[13];   //[nDiscardedJet]
   Int_t           DiscardedJet_chMult[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_leadTrackPt[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_mcEta[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_mcPhi[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_mcM[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_leptonPdgId[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_leptonPt[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_leptonPtRel[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_leptonPtRelInv[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_leptonDeltaR[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_leptonDeltaPhi[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_leptonDeltaEta[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_vtxMass[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_vtxNtracks[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_vtxPt[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_vtx3DSig[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_vtx3DVal[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_vtxPosX[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_vtxPosY[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_vtxPosZ[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_pullVectorPhi[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_pullVectorMag[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_qgl[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_ptd[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_axis2[13];   //[nDiscardedJet]
   Int_t           DiscardedJet_mult[13];   //[nDiscardedJet]
   Int_t           DiscardedJet_numberOfDaughters[13];   //[nDiscardedJet]
   Int_t           DiscardedJet_btagIdx[13];   //[nDiscardedJet]
   Int_t           DiscardedJet_mcIdx[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_pt_reg[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_pt_regVBF[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_blike_VBF[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_bTagWeightJESUp[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_bTagWeightJESDown[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_bTagWeightLFUp[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_bTagWeightLFDown[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_bTagWeightHFUp[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_bTagWeightHFDown[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_bTagWeightStats1Up[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_bTagWeightStats1Down[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_bTagWeightStats2Up[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_bTagWeightStats2Down[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_bTagWeightcErr1Up[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_bTagWeightcErr1Down[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_bTagWeightcErr2Up[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_bTagWeightcErr2Down[13];   //[nDiscardedJet]
   Float_t         DiscardedJet_bTagWeight[13];   //[nDiscardedJet]
   ...
   Int_t           TauGood_idMVA[7];   //[nTauGood]
   Int_t           TauGood_idMVANewDM[7];   //[nTauGood]
   Int_t           TauGood_idCI3hit[7];   //[nTauGood]
   Int_t           TauGood_idAntiMu[7];   //[nTauGood]
   Int_t           TauGood_idAntiE[7];   //[nTauGood]
   ...
   Float_t         Jet_btagCSV[11];   //[nJet]
   Float_t         Jet_btagCMVA[11];   //[nJet]
   Float_t         Jet_rawPt[11];   //[nJet]
   Float_t         Jet_mcPt[11];   //[nJet]
   Int_t           Jet_mcFlavour[11];   //[nJet]
   Int_t           Jet_mcMatchId[11];   //[nJet]
   Float_t         Jet_corr_JECUp[11];   //[nJet]
   Float_t         Jet_corr_JECDown[11];   //[nJet]
   Float_t         Jet_corr[11];   //[nJet]
   Float_t         Jet_corr_JERUp[11];   //[nJet]
   Float_t         Jet_corr_JERDown[11];   //[nJet]
   Float_t         Jet_corr_JER[11];   //[nJet]
   Float_t         Jet_pt[11];   //[nJet]
   Float_t         Jet_eta[11];   //[nJet]
   Float_t         Jet_phi[11];   //[nJet]
   Float_t         Jet_mass[11];   //[nJet]
   Int_t           Jet_idxFirstTauMatch[11];   //[nJet]
   Int_t           Jet_heppyFlavour[11];   //[nJet]
   Int_t           Jet_hadronFlavour[11];   //[nJet]
   Float_t         Jet_btagBDT[11];   //[nJet]
   Float_t         Jet_btagProb[11];   //[nJet]
   Float_t         Jet_btagBProb[11];   //[nJet]
   Float_t         Jet_btagSoftEl[11];   //[nJet]
   Float_t         Jet_btagSoftMu[11];   //[nJet]
   Float_t         Jet_btagnew[11];   //[nJet]
   Float_t         Jet_btagCSVV0[11];   //[nJet]
   Float_t         Jet_chHEF[11];   //[nJet]
   Float_t         Jet_neHEF[11];   //[nJet]
   Float_t         Jet_chEmEF[11];   //[nJet]
   Float_t         Jet_neEmEF[11];   //[nJet]
   Int_t           Jet_chMult[11];   //[nJet]
   Float_t         Jet_leadTrackPt[11];   //[nJet]
   Float_t         Jet_mcEta[11];   //[nJet]
   Float_t         Jet_mcPhi[11];   //[nJet]
   Float_t         Jet_mcM[11];   //[nJet]
   Float_t         Jet_leptonPdgId[11];   //[nJet]
   Float_t         Jet_leptonPt[11];   //[nJet]
   Float_t         Jet_leptonPtRel[11];   //[nJet]
   Float_t         Jet_leptonPtRelInv[11];   //[nJet]
   Float_t         Jet_leptonDeltaR[11];   //[nJet]
   Float_t         Jet_leptonDeltaPhi[11];   //[nJet]
   Float_t         Jet_leptonDeltaEta[11];   //[nJet]
   Float_t         Jet_vtxMass[11];   //[nJet]
   Float_t         Jet_vtxNtracks[11];   //[nJet]
   Float_t         Jet_vtxPt[11];   //[nJet]
   Float_t         Jet_vtx3DSig[11];   //[nJet]
   Float_t         Jet_vtx3DVal[11];   //[nJet]
   Float_t         Jet_vtxPosX[11];   //[nJet]
   Float_t         Jet_vtxPosY[11];   //[nJet]
   Float_t         Jet_vtxPosZ[11];   //[nJet]
   Float_t         Jet_pullVectorPhi[11];   //[nJet]
   Float_t         Jet_pullVectorMag[11];   //[nJet]
   Float_t         Jet_qgl[11];   //[nJet]
   Float_t         Jet_ptd[11];   //[nJet]
   Float_t         Jet_axis2[11];   //[nJet]
   Int_t           Jet_mult[11];   //[nJet]
   Int_t           Jet_numberOfDaughters[11];   //[nJet]
   Int_t           Jet_btagIdx[11];   //[nJet]
   Int_t           Jet_mcIdx[11];   //[nJet]
   Float_t         Jet_pt_reg[11];   //[nJet]
   Float_t         Jet_pt_regVBF[11];   //[nJet]
   Float_t         Jet_blike_VBF[11];   //[nJet]
   Float_t         Jet_bTagWeightJESUp[11];   //[nJet]
   Float_t         Jet_bTagWeightJESDown[11];   //[nJet]
   Float_t         Jet_bTagWeightLFUp[11];   //[nJet]
   Float_t         Jet_bTagWeightLFDown[11];   //[nJet]
   Float_t         Jet_bTagWeightHFUp[11];   //[nJet]
   Float_t         Jet_bTagWeightHFDown[11];   //[nJet]
   Float_t         Jet_bTagWeightStats1Up[11];   //[nJet]
   Float_t         Jet_bTagWeightStats1Down[11];   //[nJet]
   Float_t         Jet_bTagWeightStats2Up[11];   //[nJet]
   Float_t         Jet_bTagWeightStats2Down[11];   //[nJet]
   Float_t         Jet_bTagWeightcErr1Up[11];   //[nJet]
   Float_t         Jet_bTagWeightcErr1Down[11];   //[nJet]
   Float_t         Jet_bTagWeightcErr2Up[11];   //[nJet]
   Float_t         Jet_bTagWeightcErr2Down[11];   //[nJet]
   Float_t         Jet_bTagWeight[11];   //[nJet]
   ...
   Float_t         softActivityJets_pt[1];   //[nsoftActivityJets]
   Float_t         softActivityJets_eta[1];   //[nsoftActivityJets]
   Float_t         softActivityJets_phi[1];   //[nsoftActivityJets]
   Float_t         softActivityJets_mass[1];   //[nsoftActivityJets]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("/afs/cern.ch/user/d/degrutto/public/forFrancesco/tree.root/tree");
      tree = chain;
#endif // SINGLE_TREE
